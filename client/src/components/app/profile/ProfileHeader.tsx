...
export default observer(function ProfileHeader({ member, isEdit }: Props) {
  const {
    memberStore: { isCurrentUser, setActiveTab, follow, unfollow, loading },
  } = useStore();
        ...
        <Grid.Row>
          <Grid.Column>
            <Image
              ...
              circular
              centered
              src={member.photoUrl || require("@/assets/img/user.png")}
            />
          </Grid.Column>
            ...
            <Grid columns={2}>
              <Grid.Row>
                ...
                <Grid.Column className="followGrid">
                  ...
                  {member.followingCount} Following
                </Grid.Column>
              </Grid.Row>
            </Grid>
            ...
            {isCurrentUser === false && (
              <>
                ...
                <Button
                  ...
                  className={
                    member.following ? "followBtn unfollow" : "followBtn"
                  }
                >
                  {member.following ? (
                    <Icon
                  ...
                  {member.following ? content : "Follow"}
                </Button>
              </>
            )}
          </Grid.Column>
